          ...
          <div className="row">
            <Navbar bg="white" expand="lg" className="pt-3 mb-2">
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto menus_cata">
                  <Link to="/tilehome" className="links1">
                    <i className="fas fa-th-large"></i> Tiles |
                  </Link>
                  <Link to="/bathwarehome" className="links1">
                    <i className="fas fa-bath"></i> Bathware |
                  </Link>
                  <Link to="/catalogueshome" className="links1">
                    <i className="fas fa-download"></i> Catalogues |
                  </Link>
                  <Link to="/wtbhome" className="links1">
                    <i className="fas fa-map-marker-alt"></i> Where to buy |
                  </Link>
                  <Link to="/mediahome" className="links1">
...
export default CataloguesHeader1
